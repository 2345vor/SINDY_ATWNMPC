...
{
  incomingPacket.trim();
  // 解析控制指令 格式：speed1,speed2,speed3,speed4；前进实例：500,0,500,0；后退实例：-500,0,-500,0；左转实例：0,500,0,-500；右转实例：0,-500,0,500；
  ...
  pwmA1 = int((moto1 / 500) * 255);
  pwmB1 = int((moto2 / 500) * 255);
  // Set_Pwm( moto1,  moto2);
}
